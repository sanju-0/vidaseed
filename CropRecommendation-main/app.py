...
def main():
    ...
    background-color:#006400;color:white;font-size:20px;height:3em;width:100%;border-radius:10px 10px 10px 10px;
	}
	</style>
	"""
	st.markdown(page_bg_img, unsafe_allow_html= True)
	html_temp = """ 
    <div style ="padding:13px;margin:15px 0px;background-color:#90EE90;">
    <h1 style ="color:black;text-align:center;">Crop Recommendation </h1>
    </div>
